...
def check_if_visited(state):
    copy = state.copy()
    if tuple(copy.flatten()) in visited: #I am converting my arrays into tuple lists once they are added to visited to make parsing the visited list faster. I previously did not do this and it could not solve 31 moves in 10 minutes
        return False
    else:
